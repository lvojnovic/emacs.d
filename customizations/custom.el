;;; automatically added by customize. DO NOT TOUCH!!!
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (magit-imerge web-mode tagedit smex rjsx-mode rainbow-delimiters projectile pomidor paredit markdown-mode magit java-imports ido-ubiquitous groovy-imports flycheck exec-path-from-shell coffee-mode clojure-mode-extra-font-locking cider)))
